...
Partial Class $safeitemrootname$
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType($safeitemrootname$))
        ...
        Me.ToolStripStatusLabel.Text = "$IT_EXP_VB_Loc_Status$"
        '
        'TreeNodeImageList
        '
        ...
        Me.BackToolStripButton.Text = "$IT_EXP_VB_Loc_Back$"
        Me.BackToolStripButton.ToolTipText = "$IT_EXP_VB_Loc_Back_Tooltip$"
        '
        ...
        Me.ForwardToolStripButton.Text = "$IT_EXP_VB_Loc_Forward$"
        Me.ForwardToolStripButton.ToolTipText = "$IT_EXP_VB_Loc_Forward_Tooltip$"
        '
        'ToolStripSeparator7
        '
        ...
        Me.FoldersToolStripButton.Text = "$IT_EXP_VB_Loc_Folders$"
        Me.FoldersToolStripButton.ToolTipText = "$IT_EXP_VB_Loc_Folders_Tooltip$"
        '
        'ToolStripSeparator8
        '
        ...
        Me.ListViewToolStripButton.Text = "$IT_EXP_VB_Loc_Views$"
        '
        'ListToolStripMenuItem
        '
        Me.ListToolStripMenuItem.Name = "ListToolStripMenuItem"
        Me.ListToolStripMenuItem.Size = New System.Drawing.Size(130, 22)
        Me.ListToolStripMenuItem.Text = "$IT_EXP_VB_Loc_List$"
        '
        ...
        Me.DetailsToolStripMenuItem.Text = "$IT_EXP_VB_Loc_Details$"
        '
        ...
        Me.LargeIconsToolStripMenuItem.Text = "$IT_EXP_VB_Loc_LargeIcons$"
        '
        ...
        Me.FileToolStripMenuItem.Text = "$IT_EXP_VB_Loc_FileTS_Menu$"
        '
        ...
        Me.NewToolStripMenuItem.Text = "$IT_EXP_VB_Loc_NewTS_Menu$"
        '
        ...
        Me.OpenToolStripMenuItem.Text = "$IT_EXP_VB_Loc_OpenTS_Menu$"
        '
        'ToolStripSeparator1
        '
        ...
        Me.SaveToolStripMenuItem.Text = "$IT_EXP_VB_Loc_SaveTS_Menu$"
        '
        'SaveAsToolStripMenuItem
        '
        Me.SaveAsToolStripMenuItem.Name = "SaveAsToolStripMenuItem"
        Me.SaveAsToolStripMenuItem.Size = New System.Drawing.Size(140, 22)
        Me.SaveAsToolStripMenuItem.Text = "$IT_EXP_VB_Loc_SaveAsTS_Menu$"
        '
        'ToolStripSeparator2
        '
        ...
        Me.PrintToolStripMenuItem.Text = "$IT_EXP_VB_Loc_PrintTS_Menu$"
        '
        ...
        Me.PrintPreviewToolStripMenuItem.Text = "$IT_EXP_VB_Loc_PrintPreviewTS_Menu$"
        '
        'ToolStripSeparator3
        '
        ...
        Me.ExitToolStripMenuItem.Text = "$IT_EXP_VB_Loc_ExitTS_Menu$"
        '
        ...
        Me.EditToolStripMenuItem.Text = "$IT_EXP_VB_Loc_EditTS_Menu$"
        '
        ...
        Me.UndoToolStripMenuItem.Text = "$IT_EXP_VB_Loc_UndoTS_Menu$"
        '
        ...
        Me.RedoToolStripMenuItem.Text = "$IT_EXP_VB_Loc_RedoTS_Menu$"
        '
        'ToolStripSeparator4
        '
        ...
        Me.CutToolStripMenuItem.Text = "$IT_EXP_VB_Loc_CutTS_Menu$"
        '
        ...
        Me.CopyToolStripMenuItem.Text = "$IT_EXP_VB_Loc_CopyTS_Menu$"
        '
        ...
        Me.PasteToolStripMenuItem.Text = "$IT_EXP_VB_Loc_PasteTS_Menu$"
        '
        'ToolStripSeparator5
        '
        ...
        Me.SelectAllToolStripMenuItem.Text = "$IT_EXP_VB_Loc_SelectAllTS_Menu$"
        '
        ...
        Me.ViewToolStripMenuItem.Text = "$IT_EXP_VB_Loc_ViewTS_Menu$"
        '
        ...
        Me.ToolBarToolStripMenuItem.Text = "$IT_EXP_VB_Loc_ToolbarTS_Menu$"
        '
        ...
        Me.StatusBarToolStripMenuItem.Text = "$IT_EXP_VB_Loc_StatusBarTS_Menu$"
        '
        ...
        Me.FoldersToolStripMenuItem.Text = "$IT_EXP_VB_Loc_FolderTS_Menu$"
        '
        ...
        Me.ToolsToolStripMenuItem.Text = "$IT_EXP_VB_Loc_ToolsTS_Menu$"
        '
        'OptionsToolStripMenuItem
        '
        Me.OptionsToolStripMenuItem.Name = "OptionsToolStripMenuItem"
        Me.OptionsToolStripMenuItem.Size = New System.Drawing.Size(111, 22)
        Me.OptionsToolStripMenuItem.Text = "$IT_EXP_VB_Loc_OptionsTS_Menu$"
        '
        ...
        Me.HelpToolStripMenuItem.Text = "$IT_EXP_VB_Loc_HelpTS_Menu$"
        '
        ...
        Me.ContentsToolStripMenuItem.Text = "$IT_EXP_VB_Loc_ContentsTS_Menu$"
        '
        ...
        Me.IndexToolStripMenuItem.Text = "$IT_EXP_VB_Loc_IndexTS_Menu$"
        '
        ...
        Me.SearchToolStripMenuItem.Text = "$IT_EXP_VB_Loc_SearchTS_Menu$"
        '
        'ToolStripSeparator6
        '
        ...
        Me.AboutToolStripMenuItem.Text = "$IT_EXP_VB_Loc_AboutTS_Menu$ ..."
        '
        'ToolStripContainer
        '
        '
