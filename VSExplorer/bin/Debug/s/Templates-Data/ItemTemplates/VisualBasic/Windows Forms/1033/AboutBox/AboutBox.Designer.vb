...
Partial Class $safeitemrootname$
    ...
    Private Sub InitializeComponent()
        ...
        Me.LabelProductName.Text = "$IT_AB_VB_Loc_ProdName$"
        ...
        Me.LabelVersion.Text = "$IT_AB_VB_Loc_Version$"
        ...
        Me.LabelCopyright.Text = "$IT_AB_VB_Loc_Copyright$"
        ...
        Me.LabelCompanyName.Text = "$IT_AB_VB_Loc_CompName$"
        ...
        Me.TextBoxDescription.Text = "$IT_AB_VB_Loc_Descript$" & _
        ...
        Me.OKButton.Text = "$IT_AB_VB_Loc_OK$"
        '
        '$safeitemrootname$
        '
