...
namespace Microsoft.DotNet.CodeFormatting
{
    ...
    public class FormattingEngineImplementation : IFormattingEngine
    {
        /// <summary>
        ...
        public async Task<Solution> FormatCoreAsync(Solution originalSolution, IReadOnlyList<DocumentId> documentIds, CancellationToken cancellationToken)
        {
