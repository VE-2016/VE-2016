...
namespace Microsoft.Cci
{
    ...
    public sealed class AssemblyIdentity : ModuleIdentity
    {
          ...
          : base(template.Name, location)
        {
            ...
            _publicKeyToken = template.PublicKeyToken;
        }
        ...
        private readonly IEnumerable<byte> _publicKeyToken;
    ...
    public class ModuleIdentity : UnitIdentity
    {
        ...
        private readonly AssemblyIdentity/*?*/ _containingAssembly;
        ...
        public override bool Equals(object/*?*/ obj)
        {
            ...
            {
                if (otherMod.ContainingAssembly == null) return false;
                if (!_containingAssembly.Equals(otherMod._containingAssembly)) return false;
            }
            if (this.Name.UniqueKeyIgnoringCase != otherMod.Name.UniqueKeyIgnoringCase) return false;
            if (_containingAssembly != null) return true;
    ...
    public sealed class UnitSetIdentity
    {
        ...
        private readonly IEnumerable<UnitIdentity> _units;
    }
}