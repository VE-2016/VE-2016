...
namespace Microsoft.Cci
{
    public abstract class ArrayType : SystemDefinedStructuralType, IArrayType
    {
            ...
            get
            {
                if (_interfaces == null)
                {
                    lock (GlobalLock.LockingObject)
                    {
                        if (_interfaces == null)
                        {
                            _interfaces = this.GetInterfaceList();
                        }
                    }
                }
                return _interfaces;
        ...
        private IEnumerable<ITypeReference>/*?*/ _interfaces;
        ...
        #endregion IContainer<ITypeDefinitionMember> Members
    ...
    public class CustomModifier : ICustomModifier
    {
        ...
        private readonly ITypeReference _modifier;
    }
    ...
    public class FunctionPointerType : SystemDefinedStructuralType, IFunctionPointer
    {
        public FunctionPointerType(ISignature signature, IInternFactory internFactory)
          : base(internFactory)
        {
            _callingConvention = signature.CallingConvention;
            if (signature.ReturnValueIsModified)
                _returnValueCustomModifiers = signature.ReturnValueCustomModifiers;
            _returnValueIsByRef = signature.ReturnValueIsByRef;
            _type = signature.Type;
            _parameters = signature.Parameters;
            _extraArgumentTypes = IteratorHelper.GetEmptyEnumerable<IParameterTypeInformation>();
        }
          ...
          : base(internFactory)
        {
            ...
            _returnValueCustomModifiers = returnValueCustomModifiers;
            ...
            if (extraArgumentTypes == null)
                ...
                _extraArgumentTypes = extraArgumentTypes;
        }
        ...
        {
            get { return _extraArgumentTypes; }
        }

        private readonly IEnumerable<IParameterTypeInformation> _extraArgumentTypes;
        ...
        private readonly IEnumerable<IParameterTypeInformation> _parameters;
        ...
        public IEnumerable<ICustomModifier> ReturnValueCustomModifiers
        {
            ...
            //^^ requires this.ReturnValueIsModified;
            {
                ...
                return _returnValueCustomModifiers;
            }
        }

        private readonly IEnumerable<ICustomModifier>/*?*/ _returnValueCustomModifiers;
        ...
        {
            get { return _returnValueCustomModifiers != null; }
        }
    ...
    public class GenericTypeInstance : Scope<ITypeDefinitionMember>, IGenericTypeInstance
    {
        ...
        private readonly ITypeReference _genericType; //^ invariant genericType.ResolvedType.IsGeneric;
        ...
        public uint InternedKey
        {
            get
            {
                if (_internedKey == 0)
                {
                    _internedKey = this.InternFactory.GetTypeReferenceInternedKey(this);
                }
                return _internedKey;
            }
        }
    ...
    public class Matrix : ArrayType
    {
        ...
        public override IEnumerable<int> LowerBounds
        {
            get
            {
                if (_lowerBounds == null) return base.LowerBounds;
                return _lowerBounds;
            }
        }

        private IEnumerable<int>/*?*/ _lowerBounds;
        ...
        public override IEnumerable<ulong> Sizes
        {
            get
            {
                if (_sizes == null) return base.Sizes;
                return _sizes;
            }
        }

        private IEnumerable<ulong>/*?*/ _sizes;
    ...
    public class ModifiedPointerType : PointerType
    {
        ...
        private readonly IEnumerable<ICustomModifier> _customModifiers;
    }
    ...
    public class ModifiedTypeReference : IModifiedTypeReference
    {
        ...
        private IEnumerable<ICustomModifier> _customModifiers;
        ...
        private readonly ITypeReference _unmodifiedType;
        ...
        public uint InternedKey
        {
            get
            {
                if (_internedKey == 0)
                {
                    _internedKey = _host.InternFactory.GetTypeReferenceInternedKey(this);
                }
                return _internedKey;
            }
        }
    ...
    {
        private Dictionary<int, List<MemberType>> _caseSensitiveMemberNameToMemberListMap = new Dictionary<int, List<MemberType>>();
        private Dictionary<int, List<MemberType>> _caseInsensitiveMemberNameToMemberListMap = new Dictionary<int, List<MemberType>>();
        ...
        //^ ensures this.Contains(member);
        {
            ...
            if (_caseInsensitiveMemberNameToMemberListMap.TryGetValue(member.Name.UniqueKeyIgnoringCase, out members))
            {
            ...
            {
                _caseInsensitiveMemberNameToMemberListMap[member.Name.UniqueKeyIgnoringCase] = members = new List<MemberType>();
                members.Add(member);
            }
            if (_caseSensitiveMemberNameToMemberListMap.TryGetValue(member.Name.UniqueKey, out members))
            {
                //^ assume members != null; //Follows from the way Dictionary is instantiated, but the verifier is ignorant of this.
                if (!members.Contains(member)) members.Add(member);
            }
            ...
            {
                _caseSensitiveMemberNameToMemberListMap[member.Name.UniqueKey] = members = new List<MemberType>();
                members.Add(member);
            }
        ...
        // ^                                                            exists{INamespaceMember mem in result; mem == member}};
        {
            ...
            Dictionary<int, List<MemberType>> nameToMemberListMap = ignoreCase ? _caseInsensitiveMemberNameToMemberListMap : _caseSensitiveMemberNameToMemberListMap;
            int key = ignoreCase ? name.UniqueKeyIgnoringCase : name.UniqueKey;
            List<MemberType>/*?*/ members;
            if (!nameToMemberListMap.TryGetValue(key, out members)) return s_emptyList;
            //^ assume members != null; //Follows from the way Dictionary is instantiated, but the verifier is ignorant of this.
            return members.AsReadOnly();
        }

        private static readonly IEnumerable<MemberType> s_emptyList = (new List<MemberType>(0)).AsReadOnly();
        ...
        public virtual IEnumerable<MemberType> Members
        {
            ...
            {
                this.InitializeIfNecessary();
                foreach (IEnumerable<MemberType> namedMemberList in _caseSensitiveMemberNameToMemberListMap.Values)
      ...
      where ParameterType : IGenericParameter
    {
        ...
        public ParameterType/*!*/ UnspecializedParameter
        {
            get
            {
                return _unspecializedParameter;
            }
        }

        private readonly ParameterType/*!*/ _unspecializedParameter;
    ...
    public class SpecializedGenericTypeParameter : SpecializedGenericParameter<IGenericTypeParameter>, IGenericTypeParameter
    {
        ...
        {
            _definingType = definingTypeInstance;
        }
        ...
        private readonly IGenericTypeInstanceReference _definingType;
    ...
    public class SpecializedNestedTypeDefinition : Scope<ITypeDefinitionMember>, ISpecializedNestedTypeDefinition, ISpecializedNestedTypeReference
    {
        ...
        public IEnumerable<ITypeReference> BaseClasses
        {
            get
            {
                foreach (ITypeReference unspecializedBaseClassRef in _unspecializedVersion.BaseClasses)
                    yield return TypeDefinition.SpecializeIfConstructedFromApplicableTypeParameter(unspecializedBaseClassRef.ResolvedType, _containingGenericTypeInstance, this.InternFactory);
            }
        }
        ...
        public IEnumerable<IGenericTypeParameter> GenericParameters
        {
            get
            {
                foreach (IGenericTypeParameter unspecializedTypeParameter in _unspecializedVersion.GenericParameters)
                    yield return new SpecializedGenericTypeParameter(unspecializedTypeParameter, _containingGenericTypeInstance, this.InternFactory);
            }
            //TODO: cache this
        }
        ...
        private readonly IGenericTypeInstanceReference _containingGenericTypeInstance;
        ...
        public IEnumerable<ITypeReference> Interfaces
        {
            get
            {
                foreach (ITypeReference unspecializedInterfaceRef in _unspecializedVersion.Interfaces)
                    yield return TypeDefinition.SpecializeIfConstructedFromApplicableTypeParameter(unspecializedInterfaceRef.ResolvedType, _containingGenericTypeInstance, this.InternFactory);
            }
        }
        ...
        private readonly INestedTypeDefinition _unspecializedVersion;

        public TypeMemberVisibility Visibility
        {
            get
            {
                if (_visibility == TypeMemberVisibility.Default)
                {
                    _visibility = TypeHelper.VisibilityIntersection(this.UnspecializedVersion.Visibility,
        ...
        private TypeMemberVisibility _visibility = TypeMemberVisibility.Default;
        ...
        #endregion INestedTypeDefinition Members
        ...
        #endregion ISpecializedNestedTypeReference Members

        #region INamedTypeReference Members

        public bool MangleName
        {
            get { return _unspecializedVersion.MangleName; }
        }
