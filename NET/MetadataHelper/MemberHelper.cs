...
namespace Microsoft.Cci
{
    ...
    public class MethodReference : IMethodReference
    {
          ...
          ITypeReference returnType, IName name, ushort genericParameterCount, params ITypeReference[] parameterTypes)
        {
            ...
            _parameterCount = (ushort)parameters.Count;
        }
        ...
        {
            get { return (_callingConvention & (CallingConvention)0x7) == CallingConvention.ExtraArguments; }
        }
        ...
        public IEnumerable<IParameterTypeInformation> ExtraParameters
        {
            get
            {
                if (_extraParameters == null)
                    _extraParameters = IteratorHelper.GetEmptyEnumerable<IParameterTypeInformation>();
                return _extraParameters;
            }
        }

        private IEnumerable<IParameterTypeInformation>/*?*/ _extraParameters;
        ...
        public uint InternedKey
        {
            ...
            {
                if (_internedKey == 0)
                    _internedKey = this.host.InternFactory.GetMethodInternedKey(this);
                return _internedKey;
            }
        }
        ...
        {
            get { return _genericParameterCount > 0; }
        }
        ...
        public IMethodDefinition ResolvedMethod
        {
            get
            {
                if (_resolvedMethod == null)
                    _resolvedMethod = this.Resolve(this.ContainingType.ResolvedType);
                return _resolvedMethod;
            }
        }

        private IMethodDefinition/*?*/ _resolvedMethod;
    ...
    public class SimpleParameterTypeInformation : IParameterTypeInformation
    {
        ...
        {
            get { return _containingSignature; }
        }
    ...
    {
        private TypeNameFormatter _typeNameFormatter;
        ...
        public virtual string GetMemberSignature(ITypeMemberReference member, NameFormattingOptions formattingOptions)
        {
            ...
            if (type != null) return _typeNameFormatter.GetTypeName(type, formattingOptions);
