...
namespace Microsoft.Cci
{
    ...
    public sealed class PeReader
    {
        ...
        private readonly Hashtable<Module> _internedIdToModuleMap;
        ...
        internal Assembly/*?*/ CoreAssembly
        {
            ...
            {
                if (_coreAssembly == null)
                    _coreAssembly = this.metadataReaderHost.FindAssembly(this.metadataReaderHost.CoreAssemblySymbolicIdentity) as Assembly;
                if (_coreAssembly == Dummy.Assembly)
                    return null;
        ...
        {
            _internedIdToModuleMap.Add(module.InternedModuleId, module);
        }
        ...
        internal Assembly/*?*/ LookupAssembly(IModule/*?*/ referringModule, AssemblyIdentity unifiedAssemblyIdentity)
        {
            lock (GlobalLock.LockingObject)
            {
                ...
                Module/*?*/ module = _internedIdToModuleMap.Find(internedModuleId);
                if (module == null && referringModule != null)
                {
                    ...
                    module = _internedIdToModuleMap.Find(internedModuleId);
                }
        ...
        public IEnumerable<IModule> OpenedModules
        {
            get
            {
                foreach (Module module in _internedIdToModuleMap.Values)
                {
                    yield return module;
                }
            }
