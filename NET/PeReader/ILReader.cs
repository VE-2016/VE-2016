...
namespace Microsoft.Cci.MetadataReader.MethodBody
{
    ...
    internal sealed class MethodBody : IMethodBody
    {
        ...
        private EnumerableArrayWrapper<CilInstruction, IOperation> _cilInstructions;
        private EnumerableArrayWrapper<CilExceptionInformation, IOperationExceptionInformation> _cilExceptionInformation;
        ...
        {
            get { return _cilExceptionInformation; }
        }
    ...
    internal sealed class LocalVariableDefinition : ILocalDefinition
    {
        ...
        private readonly EnumerableArrayWrapper<CustomModifier, ICustomModifier> _customModifiers;
        ...
        {
            get { return _customModifiers.RawArray.Length > 0; }
        }
        ...
        public IEnumerable<ILocation> Locations
        {
            get
            {
                MethodBodyLocation mbLoc = new MethodBodyLocation(new MethodBodyDocument(_methodBody.MethodDefinition), _index);
        ...
        public IName Name
        {
            ...
            {
                if (_name == null)
                    _name = _methodBody.MethodDefinition.PEFileToObjectModel.NameTable.GetNameFor("local_" + _index);
                return _name;
            }
        }
    ...
    internal sealed class CilInstruction : IOperation
    {
        ...
        #endregion ICilInstruction Members
    }
    ...
    internal sealed class LocalVariableSignatureConverter : SignatureConverter
    {
        ...
        private readonly MethodBody _owningMethodBody;
    ...
    internal sealed class ILReader
    {
        ...
        private static readonly HandlerKind[] s_handlerKindMap =
          new HandlerKind[] {
        HandlerKind.Catch,  //  0
        ...
        private readonly uint _endOfMethodOffset;
        ...
        private string GetUserStringForToken(
          uint token
        )
        {
        ...
        private ILocalDefinition GetLocal(
          uint rawLocNum
        )
        {
        ...
        private IFieldReference GetField(
          uint fieldToken
        )
        {
        ...
        private object/*?*/ GetRuntimeHandleFromToken(
          uint token
        )
        {
...
namespace Microsoft.Cci.MetadataReader
{
    ...
    public sealed class MethodBodyLocation : IILLocation
    {
        ...
        private readonly MethodBodyDocument _document;
