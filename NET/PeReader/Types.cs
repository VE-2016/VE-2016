...
namespace Microsoft.Cci.MetadataReader.ObjectModelImplementation
{
    ...
    internal sealed class CoreTypeReference : MetadataObject, IModuleNamespaceType
    {
        ...
        private IModuleTypeDefAndRef/*?*/ _resolvedModuleTypeDefintion;
        ...
        public uint InternedKey
        {
            get
            {
                if (_internedKey == 0)
                {
                    _internedKey = this.PEFileToObjectModel.ModuleReader.metadataReaderHost.InternFactory.GetTypeReferenceInternedKey(this);
                }
                return _internedKey;
            }
        }
        ...
        public IModuleTypeDefAndRef/*?*/ ResolvedModuleType
        {
            get
            {
                if (!_isResolved)
                {
                    ...
                    {
                        _resolvedModuleTypeDefintion = coreAssembly.PEFileToObjectModel.FindCoreTypeReference(this);
                    }
                }
                return _resolvedModuleTypeDefintion;
            }
        }
    ...
    internal sealed class NestedNamespaceTypeNameNamespaceReference : NamespaceTypeNameNamespaceReference, INestedUnitNamespaceReference
    {
        ...
        public IUnitNamespaceReference ContainingUnitNamespace
        {
            get
            {
                if (_namespaceName.ParentNamespaceName == null)
                    return new RootNamespaceTypeNameNamespaceReference(this.NamespaceTypeNameTypeReference);
                else
                    return new NestedNamespaceTypeNameNamespaceReference(_namespaceName.ParentNamespaceName, this.NamespaceTypeNameTypeReference);
            }
        }
        ...
        public IName Name
        {
            get { return _namespaceName.Name; }
        }
    ...
    internal abstract class TypeRefReference : MetadataObject, IModuleNominalType, IModuleTypeReference, INamedEntity
    {
        ...
        private readonly IModuleModuleReference _moduleReference;
        protected readonly IName typeName;
        private bool _isResolved;
        private bool _isAliasIsInitialized;
        protected internal bool isValueType;
        private IModuleTypeDefAndRef/*?*/ _resolvedTypeDefinition;
        private ExportedTypeAliasBase/*?*/ _exportedAliasBase;
        ...
        internal void InitResolvedModuleType()
        {
            ...
            if (moduleType != null)
            {
                _resolvedTypeDefinition = moduleType;
                return;
            }
            if (!this.IsAlias) return;
            IModuleTypeReference/*?*/ modTypeRef = _exportedAliasBase.ModuleAliasedType;
            if (modTypeRef == null)
                return;
            _resolvedTypeDefinition = modTypeRef.ResolvedModuleType;
        }

        internal void InitExportedAliasBase()
        {
            if (_isAliasIsInitialized) return;
            _isAliasIsInitialized = true;
            _exportedAliasBase = this.TryResolveAsExportedType();
        }
        ...
        public IModuleTypeDefAndRef/*?*/ ResolvedModuleType
        {
            get
            {
                ...
                return _resolvedTypeDefinition;
            }
        }
        ...
        public bool IsAlias
        {
            get
            {
                if (!_isAliasIsInitialized)
                {
                    this.InitExportedAliasBase();
                }
                return _exportedAliasBase != null;
            }
        }
        ...
        public IAliasForType AliasForType
        {
            get
            {
                ...
                return _exportedAliasBase == null ? Dummy.AliasForType : _exportedAliasBase;
            }
        }
    ...
    {
        private readonly NamespaceReference _namespaceReference;
        ...
        {
            _namespaceReference = namespaceReference;
        }
        ...
        public override IName/*?*/ NamespaceFullName
        {
            get
            {
                return _namespaceReference.NamespaceFullName;
            }
        }
    ...
    {
        private readonly IName _mangledTypeName;
        private readonly ushort _genericParamCount;
        ...
        internal GenericNamespaceTypeRefReference(
          ...
          : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, namespaceReference, isValueType)
        {
            _mangledTypeName = mangledTypeName;
            _genericParamCount = genericParamCount;
        }

        public override ushort GenericParameterCount
        {
            get { return _genericParamCount; }
        }

        public override IName MangledTypeName
        {
            get { return _mangledTypeName; }
        }
    ...
    {
        private readonly ModuleSignatureTypeCode _signatureTypeCode;
        ...
        {
            _signatureTypeCode = signatureTypeCode;
        ...
        public override ModuleSignatureTypeCode SignatureTypeCode
        {
            get { return _signatureTypeCode; }
        }
    }

    internal abstract class NestedTypeRefReference : TypeRefReference, IModuleNestedType
    {
        private readonly TypeRefReference _parentTypeReference;
        ...
        internal NestedTypeRefReference(
          ...
          : base(peFileToObjectModel, typeName, typeRefRowId, moduleReference, isValueType)
        {
            _parentTypeReference = parentTypeReference;
        }
        ...
        internal override ExportedTypeAliasBase/*?*/ TryResolveAsExportedType()
        {
            ExportedTypeAliasBase/*?*/ parentExportedType = _parentTypeReference.TryResolveAsExportedType();
        ...
        public ITypeReference ContainingType
        {
            get { return _parentTypeReference; }
        }
    ...
    internal sealed class GenericNestedTypeRefReference : NestedTypeRefReference
    {
        ...
        public override bool MangleName
        {
            get
            {
                return this.typeName.UniqueKey != _mangledTypeName.UniqueKey;
            }
        }
    }
    ...
    internal sealed class TypeSpecReference : MetadataObject, IModuleTypeReference
    {
        ...
        private bool _underlyingTypeInited;
        private IModuleTypeReference/*?*/ _underlyingModuleTypeReference;
        ...
        internal IModuleTypeReference/*?*/ UnderlyingModuleTypeReference
        {
            get
            {
                if (!_underlyingTypeInited)
                {
                    _underlyingTypeInited = true;
                    _underlyingModuleTypeReference = this.PEFileToObjectModel.UnderlyingModuleTypeSpecReference(this);
                }
                return _underlyingModuleTypeReference;
            }
        }
    ...
    {
        private readonly ITypeDefinition _containingType;
        private readonly IMethodReference _methodDeclaration;
        private readonly IMethodReference _methodBody;
    ...
    internal abstract class TypeBase : ScopedContainerMetadataObject<IModuleTypeDefinitionMember, ITypeDefinitionMember, ITypeDefinition>, IModuleGenericType, IModuleNominalType, INamedTypeDefinition
    {
        ...
        private uint _interfaceRowIdStart;
        private uint _interfaceRowIdEnd;
          ...
          : base(peFileToObjectModel)
        {
            ...
            _interfaceRowIdStart = 0xFFFFFFFF;
        ...
        internal uint InterfaceRowIdStart
        {
            get
            {
                if (_interfaceRowIdStart == 0xFFFFFFFF)
                {
                    this.PEFileToObjectModel.GetInterfaceInfoForType(this, out _interfaceRowIdStart, out _interfaceRowIdEnd);
                }
                return _interfaceRowIdStart;
            }
        }
        ...
        internal uint InterfaceCount
        {
            get
            {
                ...
                return _interfaceRowIdEnd - _interfaceRowIdStart;
            }
        }
    ...
    internal abstract class NamespaceType : TypeBase, IModuleNamespaceType, INamespaceTypeDefinition
    {
        ...
        public override IName/*?*/ NamespaceFullName
        {
            get { return _parentModuleNamespace.NamespaceFullName; }
        }
    ...
    {
        private IModuleTypeReference/*?*/ _enumUnderlyingType;
        //^ [NotDelayed]
                ...
                if ((this.initFlags & TypeBase.EnumInited) != TypeBase.EnumInited)
                {
                    ...
                    if (this.IsEnum)
                    {
                        foreach (ITypeDefinitionMember tdm in this.GetMembersNamed(this.PEFileToObjectModel.ModuleReader.value__, false))
                        {
                            ...
                            if (mf == null)
                                continue;
                            _enumUnderlyingType = mf.FieldType;
                            break;
                        }
                    }
                }
    ...
    {
        private ModuleSignatureTypeCode _signatureTypeCode;
        //^ [NotDelayed]
        ...
        public override PrimitiveTypeCode TypeCode
        {
            get { return TypeCache.PrimitiveTypeCodeConv[(int)_signatureTypeCode]; }
        }
    }

    internal sealed class GenericNamespaceType : NamespaceType
    {
        private readonly IName _mangledName;
        private readonly uint _genericParamRowIdStart;
        private readonly uint _genericParamRowIdEnd;
        private IGenericTypeInstanceReference/*?*/ _genericTypeInstance;
          ...
          : base(peFileToObjectModel, unmangledName, typeDefRowId, typeDefFlags, parentModuleNamespace)
        {
            ...
            //^ base;
            _genericParamRowIdStart = genericParamRowIdStart;
            _genericParamRowIdEnd = genericParamRowIdEnd;
        }
        ...
        public override IEnumerable<IGenericTypeParameter> GenericParameters
        {
            get
            {
                uint genericRowIdEnd = _genericParamRowIdEnd;
                for (uint genericParamIter = _genericParamRowIdStart; genericParamIter < genericRowIdEnd; ++genericParamIter)
                {
        ...
        public override ushort GenericParameterCount
        {
            get
            {
                return (ushort)(_genericParamRowIdEnd - _genericParamRowIdStart);
            }
        }
                ...
                if (_genericTypeInstance == null)
                {
                    lock (GlobalLock.LockingObject)
                    {
                        if (_genericTypeInstance == null)
                        {
                            ...
                            _genericTypeInstance = gtir.ResolvedModuleType as IGenericTypeInstanceReference;
                            if (_genericTypeInstance == null)
                            {
                                //  MDError...
                                _genericTypeInstance = Dummy.GenericTypeInstance;
                            }
                        }
                    }
                }
                return _genericTypeInstance;
            }
        }

        public override ushort GenericTypeParameterCardinality
        {
            get { return (ushort)(_genericParamRowIdEnd - _genericParamRowIdStart); }
        }
        ...
        public override IModuleTypeReference/*?*/ GetGenericTypeParameterFromOrdinal(ushort genericParamOrdinal)
        {
            ...
            uint genericRowId = _genericParamRowIdStart + genericParamOrdinal;
        ...
        public override bool MangleName
        {
            get { return this.Name.UniqueKey != _mangledName.UniqueKey; }
        }
    ...
    {
        private readonly IModuleTypeReference _moduleTypeReference;
        private readonly ushort _genericParameterOrdinality;
        private readonly ushort _genericParameterIndex;
          ...
          : base(peFileToObjectModel)
        {
            ...
            _moduleTypeReference = moduleTypeReference;
            _genericParameterIndex = genericParameterIndex;
            _genericParameterOrdinality = genericParameterOrdinality;
        }
        ...
        {
            get { return _genericParameterIndex; }
        }

        public override ushort Ordinal
        {
            get { return _genericParameterOrdinality; }
        }

        public override IModuleTypeReference/*?*/ SpecializeTypeInstance(IModuleGenericTypeInstance genericTypeInstance)
        {
            return genericTypeInstance.GetGenericTypeArgumentFromOrdinal(_genericParameterOrdinality);
        }
        ...
        public override IName Name
        {
            get
            {
                if (_name == null)
                {
                    ...
                    if (definingType.GenericParameterCount <= _genericParameterIndex)
                        _name = this.PEFileToObjectModel.NameTable.GetNameFor("!" + this.Ordinal);
                    else
                    {
                        int i = 0;
                        _name = Dummy.Name;
                        ...
                        {
                            if (i++ < _genericParameterIndex) continue;
                            _name = par.Name;
                            break;
                        }
                    }
        ...
        {
            get { return _moduleTypeReference; }
        }
        ...
        public ITypeDefinition DefiningType
        {
            get
            {
                IModuleTypeDefAndRef/*?*/ moduleTypeDefAndRef = _moduleTypeReference.ResolvedModuleType;
                if (moduleTypeDefAndRef == null) return Dummy.Type;
                return moduleTypeDefAndRef;
            }
        }
    ...
    {
        private readonly IModuleMethodReference _moduleMethodReference;
        private readonly ushort _genericParameterOrdinality;
        ...
        internal SignatureGenericMethodParameter(
          ...
          : base(peFileToObjectModel)
        {
            _moduleMethodReference = moduleMethodReference;
            _genericParameterOrdinality = genericParameterOrdinality;
        }
        ...
        public override IName Name
        {
            get
            {
                if (_name == null)
                {
                    ...
                    if (definingMethod.GenericParameterCount <= _genericParameterOrdinality)
                        _name = this.PEFileToObjectModel.NameTable.GetNameFor("!!" + this.Index);
                    else
                    {
                        int i = 0;
                        _name = Dummy.Name;
                        ...
                        {
                            if (i++ < _genericParameterOrdinality) continue;
                            _name = par.Name;
                            break;
                        }
                    }
        ...
        public override IModuleTypeReference/*?*/ SpecializeMethodInstance(IModuleGenericMethodInstance genericMethodInstance)
        {
            return genericMethodInstance.GetGenericMethodArgumentFromOrdinal(_genericParameterOrdinality);
        }
        ...
        {
            get { return _moduleMethodReference; }
        }
        ...
        {
            get { return _moduleMethodReference.ResolvedMethod; }
        }
    ...
    internal abstract class SimpleStructuralType : MetadataDefinitionObject, IModuleTypeDefAndRef
    {
        ...
        protected SimpleStructuralType(
          ...
          : base(peFileToObjectModel)
        {
            _typeSpecToken = typeSpecToken;
        }

        internal override uint TokenValue
        {
            get { return _typeSpecToken; }
        }
    ...
    internal abstract class GenericParameter : SimpleStructuralType, IModuleGenericParameter
    {
        ...
        private uint _genericParamConstraintRowIDStart;
        private uint _genericParamConstraintRowIDEnd;
          ...
          : base(peFileToObjectModel, TokenTypeIds.GenericParam | genericParameterRowId)
        {
            ...
            _genericParamConstraintRowIDStart = 0xFFFFFFFF;
            _genericParamConstraintRowIDEnd = 0xFFFFFFFF;
        }
        ...
        internal uint GenericParamConstraintRowIDStart
        {
            get
            {
                if (_genericParamConstraintRowIDStart == 0xFFFFFFFF)
                {
                    this.PEFileToObjectModel.GetConstraintInfoForGenericParam(this, out _genericParamConstraintRowIDStart, out _genericParamConstraintRowIDEnd);
                }
                return _genericParamConstraintRowIDStart;
            }
        }
        ...
        internal uint GenericParamConstraintRowIDEnd
        {
            get
            {
                ...
                return _genericParamConstraintRowIDEnd;
            }
        }
        ...
        internal uint GenericParamConstraintCount
        {
            get
            {
                ...
                return _genericParamConstraintRowIDEnd - _genericParamConstraintRowIDStart;
            }
        }
    ...
    { //TODO: make this a reference, not a def
    ...
    {
        private EnumerableArrayWrapper<IModuleTypeReference/*?*/, ITypeReference>/*?*/ _constraints;
        ...
        internal EnumerableArrayWrapper<IModuleTypeReference/*?*/, ITypeReference> Constraints
        {
            get
            {
                ...
                {
                    _constraints = TypeCache.EmptyTypeArray;
                    ...
                    if (constraintCount > 0)
                    {
                        ...
                        _constraints = new EnumerableArrayWrapper<IModuleTypeReference/*?*/, ITypeReference>(constraintsRawArray, Dummy.TypeReference);
                    }
                }
                return _constraints;
            }
        ...
        public uint InternedKey
        {
            get
            {
                if (_internedKey == 0)
                {
                    _internedKey = this.SpecializingGenericTypeInstance.PEFileToObjectModel.ModuleReader.metadataReaderHost.InternFactory.GetTypeReferenceInternedKey(this);
                }
                return _internedKey;
            }
        }
    ...
    {
        private readonly IModuleGenericTypeInstance _moduleGenericTypeInstance;
        ...
        {
            _moduleGenericTypeInstance = moduleGenericTypeInstance;
        ...
        internal override IModuleGenericTypeInstance SpecializingGenericTypeInstance
        {
            get { return _moduleGenericTypeInstance; }
        }
    ...
    internal sealed class NamespaceTypeGenericInstanceReference : GenericTypeInstanceReference, IGenericTypeInstanceReference
    {
        ...
        private NamespaceTypeGenericInstance/*?*/ _namespaceTypeGenericInstance;
        ...
        internal override GenericTypeInstance/*?*/ ResolvedGenericTypeInstance
        {
            get
            {
                if ((this.Flags & GenericTypeInstanceReference.IsResolved) != GenericTypeInstanceReference.IsResolved)
                {
                    ...
                    {
                        _namespaceTypeGenericInstance = new NamespaceTypeGenericInstance(this, genericNamespaceType);
                    }
                }
                return _namespaceTypeGenericInstance;
            }
        }
    ...
    internal sealed class NestedTypeGenericInstanceWithOwnerGenericInstanceReference : GenericTypeInstanceReference, IGenericTypeInstanceReference
    {
        ...
        private NestedTypeGenericInstanceWithOwnerGenericInstance/*?*/ _nestedTypeGenericInstanceWithOwnerGenericInstance;
        ...
        internal override GenericTypeInstance/*?*/ ResolvedGenericTypeInstance
        {
            get
            {
                if ((this.Flags & GenericTypeInstanceReference.IsResolved) != GenericTypeInstanceReference.IsResolved)
                {
                    ...
                    {
                        _nestedTypeGenericInstanceWithOwnerGenericInstance = new NestedTypeGenericInstanceWithOwnerGenericInstance(this.PEFileToObjectModel, this, specializedNestedGenericType);
                    }
                }
                return _nestedTypeGenericInstanceWithOwnerGenericInstance;
            }
        }
    ...
    internal sealed class NestedTypeGenericInstanceWithOwnerNonGenericInstanceReference : GenericTypeInstanceReference, IGenericTypeInstanceReference
    {
        ...
        internal readonly EnumerableArrayWrapper<IModuleTypeReference/*?*/, ITypeReference> TypeArguments;  //  <float>
        private NestedTypeGenericInstanceWithOwnerNonGenericInstance/*?*/ _nestedTypeGenericInstanceWithOwnerNonGenericInstance;
        ...
        internal override GenericTypeInstance/*?*/ ResolvedGenericTypeInstance
        {
            get
            {
                if ((this.Flags & GenericTypeInstanceReference.IsResolved) != GenericTypeInstanceReference.IsResolved)
                {
                    ...
                    {
                        _nestedTypeGenericInstanceWithOwnerNonGenericInstance = new NestedTypeGenericInstanceWithOwnerNonGenericInstance(this.PEFileToObjectModel, this, genericNestedType);
                    }
                }
                return _nestedTypeGenericInstanceWithOwnerNonGenericInstance;
            }
        }
    ...
    {
        private SpecializedNestedNonGenericType/*?*/ _specializedNestedNonGenericType;
        ...
        protected override SpecializedNestedTypePartialGenericInstance/*?*/ ResolvedNestedTypePartialGenericInstance
        {
            get
            {
                if ((this.Flags & GenericTypeInstanceReference.IsResolved) != GenericTypeInstanceReference.IsResolved)
                {
                    ...
                    if (genericNestedType == null)
                        return null;
                    _specializedNestedNonGenericType = new SpecializedNestedNonGenericType(this.PEFileToObjectModel, this, owningGenericTypeInstance, genericNestedType);
                }
                return _specializedNestedNonGenericType;
            }
        }
    ...
    {
        private readonly ushort _genericParameterCount;  //  <T..>
        private SpecializedNestedGenericType/*?*/ _specializedNestedGenericType;
        ...
        protected override SpecializedNestedTypePartialGenericInstance/*?*/ ResolvedNestedTypePartialGenericInstance
        {
            get
            {
                if ((this.Flags & GenericTypeInstanceReference.IsResolved) != GenericTypeInstanceReference.IsResolved)
                {
                    ...
                    foreach (GenericNestedType gnt in IteratorHelper.GetFilterEnumerable<ITypeDefinitionMember, GenericNestedType>(owningGenericTypeInstance.RawTemplateModuleType.GetMembersNamed(this.Name, false)))
                    {
                        if (gnt.GenericParameterCount == _genericParameterCount)
                        {
                            genericNestedType = gnt;
                            break;
                        }
                    ...
                    if (genericNestedType == null)
                        return null;
                    _specializedNestedGenericType = new SpecializedNestedGenericType(this.PEFileToObjectModel, this, owningGenericTypeInstance, genericNestedType);
                }
                return _specializedNestedGenericType;
            }
        }
    ...
    {
        private IModuleTypeReference/*?*/ _baseTypeReference;
        private EnumerableArrayWrapper<IModuleTypeReference/*?*/, ITypeReference>/*?*/ _interfaces;
        ...
        internal IModuleTypeReference/*?*/ BaseTypeReference
        {
            get
            {
                if ((this.ModuleGenericTypeInstanceReference.Flags & GenericTypeInstanceReference.IsBaseInited) != GenericTypeInstanceReference.IsBaseInited)
                {
                    ...
                    if (moduleTypeRef != null)
                    {
                        _baseTypeReference = this.RawTemplateModuleType.BaseTypeReference.SpecializeTypeInstance(this);
                    }
                }
                return _baseTypeReference;
            }
        }
        ...
        public IEnumerable<ITypeReference> Interfaces
        {
            get
            {
                if (_interfaces == null)
                {
                    _interfaces = TypeCache.EmptyTypeArray;
                    ...
                    if (interfaceCount > 0)
                    {
                        ...
                        _interfaces = new EnumerableArrayWrapper<IModuleTypeReference/*?*/, ITypeReference>(interfacesRawArray, Dummy.TypeReference);
                    }
                }
                return _interfaces;
            }
    ...
    {
        private readonly NamespaceTypeGenericInstanceReference _namespaceTypeGenericInstanceReference;
        private readonly GenericNamespaceType _namespaceGenericType;
        ...
        {
            _namespaceTypeGenericInstanceReference = namespaceTypeGenericInstanceReference;
            _namespaceGenericType = namespaceGenericTypeTemplate;
        }
        ...
        internal override GenericTypeInstanceReference ModuleGenericTypeInstanceReference
        {
            get
            {
                return _namespaceTypeGenericInstanceReference;
            }
        }
        ...
        {
            get { return _namespaceTypeGenericInstanceReference.GenericArguments; }
        }

        ITypeReference IGenericTypeInstanceReference.GenericType
        {
            get { return _namespaceGenericType; }
        }
    ...
    {
        private readonly NestedTypeGenericInstanceWithOwnerGenericInstanceReference _nestedTypeGenericInstanceWithOwnerGenericInstanceReference;
        ...
        internal NestedTypeGenericInstanceWithOwnerGenericInstance(
          ...
          : base(peFileToObjectModel)
        {
            _nestedTypeGenericInstanceWithOwnerGenericInstanceReference = nestedTypeGenericInstanceWithOwnerGenericInstanceReference;
        ...
        internal override GenericTypeInstanceReference ModuleGenericTypeInstanceReference
        {
            get { return _nestedTypeGenericInstanceWithOwnerGenericInstanceReference; }
        }
        ...
        IEnumerable<ITypeReference> IGenericTypeInstanceReference.GenericArguments
        {
            get
            {
                return _nestedTypeGenericInstanceWithOwnerGenericInstanceReference.GenericArguments;
            }
        }
    ...
    {
        private readonly NestedTypeGenericInstanceWithOwnerNonGenericInstanceReference _nestedTypeGenericInstanceWithOwnerNonGenericInstanceReference;
        private readonly GenericNestedType _genericType;
        ...
        internal NestedTypeGenericInstanceWithOwnerNonGenericInstance(
          ...
          : base(peFileToObjectModel)
        {
            _nestedTypeGenericInstanceWithOwnerNonGenericInstanceReference = nestedTypeGenericInstanceWithOwnerNonGenericInstanceReference;
        ...
        internal override GenericTypeInstanceReference ModuleGenericTypeInstanceReference
        {
            get { return _nestedTypeGenericInstanceWithOwnerNonGenericInstanceReference; }
        }
        ...
        IEnumerable<ITypeReference> IGenericTypeInstanceReference.GenericArguments
        {
            get { return _nestedTypeGenericInstanceWithOwnerNonGenericInstanceReference.TypeArguments; }
        }
    ...
    {
        private readonly SpecializedNestedNonGenericTypeReference _specializedNestedNonGenericTypeReference;
        ...
        {
            _specializedNestedNonGenericTypeReference = specializedNestedNonGenericTypeReference;
            //^ base;
        }
        ...
        internal override GenericTypeInstanceReference ModuleGenericTypeInstanceReference
        {
            get { return _specializedNestedNonGenericTypeReference; }
        }
    ...
    {
        private readonly SpecializedNestedGenericTypeReference _specializedNestedGenericTypeReference;
        private readonly EnumerableArrayWrapper<IModuleGenericTypeParameter, IGenericTypeParameter> _genericTypeParameters;
        private IGenericTypeInstance/*?*/ _genericTypeInstance;
        ...
        internal SpecializedNestedGenericType(
          ...
          : base(peFileToObjectModel, owningGenericTypeInstance, rawNestedGenericTypeTemplate)
        {
            _specializedNestedGenericTypeReference = specializedNestedGenericTypeReference;
            ...
            _genericTypeParameters = new EnumerableArrayWrapper<IModuleGenericTypeParameter, IGenericTypeParameter>(specializedGenericParamArray, Dummy.GenericTypeParameter);
        }
        ...
        internal override GenericTypeInstanceReference ModuleGenericTypeInstanceReference
        {
            get { return _specializedNestedGenericTypeReference; }
        }
        ...
        public override ushort GenericParameterCount
        {
            get { return (ushort)_genericTypeParameters.RawArray.Length; }
        }
                ...
                if (_genericTypeInstance == null)
                {
                    lock (GlobalLock.LockingObject)
                    {
                        if (_genericTypeInstance == null)
                        {
                            ...
                            _genericTypeInstance = gtir.ResolvedModuleType as IGenericTypeInstance;
                            if (_genericTypeInstance == null)
                            {
                                //  MDError...
                                _genericTypeInstance = Dummy.GenericTypeInstance;
    ...
    internal abstract class ExportedTypeAliasBase : ScopedContainerMetadataObject<IAliasMember, IAliasMember, IAliasForType>, IAliasForType
    {
        ...
        internal readonly TypeDefFlags TypeDefFlags;
        private bool _isAliasInited;
        private IModuleTypeReference/*?*/ _aliasTypeReference;
        ...
        internal IModuleTypeReference/*?*/ ModuleAliasedType
        {
            get
            {
                ...
                {
                    _isAliasInited = true;
                    _aliasTypeReference = this.PEFileToObjectModel.FindExportedType(this);
                }
                return _aliasTypeReference;
            }
        }
    ...
    {
        private readonly ExportedTypeAliasBase _parentExportedTypeAlias;
        ...
        internal ExportedTypeNestedAlias(
          ...
          : base(peFileToObjectModel, typeName, exportedTypeDefRowId, typeDefFlags)
        {
            _parentExportedTypeAlias = parentExportedTypeAlias;
        }
        ...
        {
            get { return _parentExportedTypeAlias; }
        }
    ...
    internal abstract class Parameter : MetadataDefinitionObject, IModuleParameter
    {
        ...
        private readonly ISignature _containingSignatureDefinition;
          ...
          : base(peFileToObjectModel)
        {
            ...
            _containingSignatureDefinition = containingSignatureDefinition;
        }
        ...
        public ISignature ContainingSignature
        {
            get
            {
                return _containingSignatureDefinition;
            }
        }
    ...
    internal sealed class ParameterInfo : MetadataObject, IModuleParameterTypeInformation
    {
        ...
        internal readonly IModuleTypeReference/*?*/ TypeReference;
        private readonly ISignature _containingSignatureDefinition;
        private readonly bool _isByReference;
        ...
        public ISignature ContainingSignature
        {
            get { return _containingSignatureDefinition; }
        }
    ...
    {
        private ParamFlags _parameterFlags;
        private IName _parameterName;
        private uint _paramRowId;
        //^ [NotDelayed]
          ...
          : base(peFileToObjectModel, parameterIndex, moduleCustomModifiers, typeReference, containingSignatureDefinition)
        {
            ...
            if (isByReference)
            {
                _parameterFlags |= ParamFlags.ByReference;
            }
            _paramRowId = paramRowId;
            ...
            if (possibleParamArray)
            {
                foreach (ICustomAttribute ica in this.Attributes)
                {
                    ...
                    if (ca == null || ca.Constructor.OwningTypeReference != peFileToObjectModel.SystemParamArrayAttribute)
                        continue;
                    _parameterFlags |= ParamFlags.ParamArray;
                    break;
                }
            }
        }
        ...
        internal override uint TokenValue
        {
            get { return TokenTypeIds.ParamDef | _paramRowId; }
        }
        ...
        {
            get { return (_parameterFlags & ParamFlags.HasDefaultReserved) == ParamFlags.HasDefaultReserved; }
        }

        public override bool IsByReference
        {
            get { return (_parameterFlags & ParamFlags.ByReference) == ParamFlags.ByReference; }
        }

        public override bool IsIn
        {
            get { return (_parameterFlags & ParamFlags.InSemantics) == ParamFlags.InSemantics; }
        }

        //^[Pure]
        public override bool IsMarshalledExplicitly
        {
            get { return (_parameterFlags & ParamFlags.HasFieldMarshalReserved) == ParamFlags.HasFieldMarshalReserved; }
        }

        public override bool IsOptional
        {
            get { return (_parameterFlags & ParamFlags.OptionalSemantics) == ParamFlags.OptionalSemantics; }
        }

        public override bool IsOut
        {
            get { return (_parameterFlags & ParamFlags.OutSemantics) == ParamFlags.OutSemantics; }
        }

        public override bool IsParameterArray
        {
            get { return (_parameterFlags & ParamFlags.ParamArray) == ParamFlags.ParamArray; }
        }
    ...
    internal sealed class TypeCache
    {
      ...
      PrimitiveTypeCode.NotPrimitive,  //NotModulePrimitive,
        ...
        internal readonly PEFileToObjectModel PEFileToObjectModel;
        private Hashtable<ITypeReference> _moduleTypeHashTable;
        ...
        {
            this.PEFileToObjectModel = peFileToObjectModel;
            _moduleTypeHashTable = new Hashtable<ITypeReference>();
        }
        ...
        private GenericTypeInstanceReference/*?*/ GetGenericTypeInstanceReferenceInternal(
        ...
        private static T[] GetSubArray<T>(T[] tArray, uint startIndex, uint count)
        {
        ...
        private static TypeMemberVisibility[,] s_LUB = {
      ...
      {   TypeMemberVisibility.Default, TypeMemberVisibility.Public,            TypeMemberVisibility.Public,            TypeMemberVisibility.Public,            TypeMemberVisibility.Public,            TypeMemberVisibility.Public,            TypeMemberVisibility.Public,            TypeMemberVisibility.Public   },   //  Public
        ...
        private static TypeMemberVisibility[,] s_GLB = {
      //  TypeMemberVisibility.Default, TypeMemberVisibility.Assembly,          TypeMemberVisibility.Family,            TypeMemberVisibility.FamilyAndAssembly, TypeMemberVisibility.FamilyOrAssembly,  TypeMemberVisibility.Other,   TypeMemberVisibility.Private, TypeMemberVisibility.Public
      {   TypeMemberVisibility.Default, TypeMemberVisibility.Default,           TypeMemberVisibility.Default,           TypeMemberVisibility.Default,           TypeMemberVisibility.Default,           TypeMemberVisibility.Default, TypeMemberVisibility.Default, TypeMemberVisibility.Default            },   //  Default
      ...
      {   TypeMemberVisibility.Default, TypeMemberVisibility.Assembly,          TypeMemberVisibility.Family,            TypeMemberVisibility.FamilyAndAssembly, TypeMemberVisibility.FamilyOrAssembly,  TypeMemberVisibility.Other,   TypeMemberVisibility.Private, TypeMemberVisibility.Public             },   //  Public
        ...
        {
            return TypeCache.s_LUB[(int)left, (int)right];
        }
