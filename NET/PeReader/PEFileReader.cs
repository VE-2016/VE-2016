...
namespace Microsoft.Cci.MetadataReader.PEFile
{
    ...
    internal unsafe struct NestedClassTableReader
    {
        ...
        internal NestedClassRow this[uint rowId]
        { //  This is 1 based...
            get
            {
                int rowOffset = (int)(rowId - 1) * this.RowSize;
    ...
    internal unsafe sealed class PEFileReader
    {
        ...
        private COFFFileHeader _COFFFileHeader;
        private OptionalHeaderStandardFields _optionalHeaderStandardFields;
        private OptionalHeaderNTAdditionalFields _optionalHeaderNTAdditionalFields;
        ...
        internal DllCharacteristics DllCharacteristics
        {
            ...
            {
                return _optionalHeaderNTAdditionalFields.DllCharacteristics;
            }
        }
        ...
        internal uint FileAlignment
        {
            ...
            //^ requires this.ReaderState >= ReaderState.PEFile;
            {
                return _optionalHeaderNTAdditionalFields.FileAlignment;
            }
        }
        ...
        internal ulong ImageBase
        {
            ...
            //^ requires this.ReaderState >= ReaderState.PEFile;
            {
                return _optionalHeaderNTAdditionalFields.ImageBase;
            }
        }
        ...
        internal bool IsDll
        {
            ...
            //^ requires this.ReaderState >= ReaderState.PEFile;
            {
                return (_COFFFileHeader.Characteristics & Characteristics.Dll) != 0;
            }
        }
        ...
        internal bool IsConsoleApplication
        {
            get
            {
                return _optionalHeaderNTAdditionalFields.Subsystem == Subsystem.WindowsCUI;
            }
        }
        ...
        internal bool IsUnmanaged
        {
            get
            {
                return _optionalHeaderDirectoryEntries.COR20HeaderTableDirectory.Size == 0;
            }
        }
        ...
        internal byte LinkerMajorVersion
        {
            ...
            //^ requires this.ReaderState >= ReaderState.PEFile;
            {
                return _optionalHeaderStandardFields.MajorLinkerVersion;
            }
        }
        ...
        internal byte LinkerMinorVersion
        {
            ...
            //^ requires this.ReaderState >= ReaderState.PEFile;
            {
                return _optionalHeaderStandardFields.MinorLinkerVersion;
            }
        }
        ...
        internal bool RequiresAmdInstructionSet
        {
            get
            {
                return _COFFFileHeader.Machine == Machine.AMD64;
            }
        }
        ...
        internal bool Requires64Bits
        {
            get
            {
                return _optionalHeaderStandardFields.PEMagic == PEMagic.PEMagic64
                  || _COFFFileHeader.Machine == Machine.AMD64
                  || _COFFFileHeader.Machine == Machine.IA64;
            }
        }
        ...
        internal ulong SizeOfHeapCommit
        {
            ...
            //^ requires this.ReaderState >= ReaderState.PEFile;
            {
                return _optionalHeaderNTAdditionalFields.SizeOfHeapCommit;
            }
        }
        ...
        internal ulong SizeOfHeapReserve
        {
            ...
            //^ requires this.ReaderState >= ReaderState.PEFile;
            {
                return _optionalHeaderNTAdditionalFields.SizeOfHeapReserve;
            }
        }
        ...
        internal ulong SizeOfStackCommit
        {
            ...
            //^ requires this.ReaderState >= ReaderState.PEFile;
            {
                return _optionalHeaderNTAdditionalFields.SizeOfStackCommit;
            }
        }
        ...
        internal ulong SizeOfStackReserve
        {
            ...
            //^ requires this.ReaderState >= ReaderState.PEFile;
            {
                return _optionalHeaderNTAdditionalFields.SizeOfStackReserve;
            }
        }
        ...
        private bool ReadCOFFFileHeader(
        ...
        //^ requires this.ReaderState >= ReaderState.Initialized;
        {
            ...
            _COFFFileHeader.Machine = (Machine)memReader.ReadUInt16();
            _COFFFileHeader.NumberOfSections = memReader.ReadInt16();
            _COFFFileHeader.TimeDateStamp = memReader.ReadInt32();
            _COFFFileHeader.PointerToSymbolTable = memReader.ReadInt32();
            _COFFFileHeader.NumberOfSymbols = memReader.ReadInt32();
            _COFFFileHeader.SizeOfOptionalHeader = memReader.ReadInt16();
            _COFFFileHeader.Characteristics = (Characteristics)memReader.ReadUInt16();
            return true;
        }

        private bool ReadOptionalHeaderStandardFields32(
          ref MemoryReader memReader
        )
        //^ requires this.ReaderState >= ReaderState.Initialized;
        {
            ...
            _optionalHeaderStandardFields.PEMagic = (PEMagic)memReader.ReadUInt16();
            _optionalHeaderStandardFields.MajorLinkerVersion = memReader.ReadByte();
            _optionalHeaderStandardFields.MinorLinkerVersion = memReader.ReadByte();
            _optionalHeaderStandardFields.SizeOfCode = memReader.ReadInt32();
            _optionalHeaderStandardFields.SizeOfInitializedData = memReader.ReadInt32();
            _optionalHeaderStandardFields.SizeOfUninitializedData = memReader.ReadInt32();
            _optionalHeaderStandardFields.RVAOfEntryPoint = memReader.ReadInt32();
            _optionalHeaderStandardFields.BaseOfCode = memReader.ReadInt32();
            _optionalHeaderStandardFields.BaseOfData = memReader.ReadInt32();
            return true;
        }

        private bool ReadOptionalHeaderNTAdditionalFields32(
          ref MemoryReader memReader
        )
        //^ requires this.ReaderState >= ReaderState.Initialized;
        {
            ...
            _optionalHeaderNTAdditionalFields.ImageBase = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.SectionAlignment = memReader.ReadInt32();
            _optionalHeaderNTAdditionalFields.FileAlignment = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.MajorOperatingSystemVersion = memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.MinorOperatingSystemVersion = memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.MajorImageVersion = memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.MinorImageVersion = memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.MajorSubsystemVersion = memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.MinorSubsystemVersion = memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.Win32VersionValue = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.SizeOfImage = memReader.ReadInt32();
            _optionalHeaderNTAdditionalFields.SizeOfHeaders = memReader.ReadInt32();
            _optionalHeaderNTAdditionalFields.CheckSum = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.Subsystem = (Subsystem)memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.DllCharacteristics = (DllCharacteristics)memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.SizeOfStackReserve = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.SizeOfStackCommit = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.SizeOfHeapReserve = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.SizeOfHeapCommit = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.LoaderFlags = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.NumberOfRvaAndSizes = memReader.ReadInt32();
            return true;
        }

        private bool ReadOptionalHeaderStandardFields64(
          ref MemoryReader memReader
        )
        //^ requires this.ReaderState >= ReaderState.Initialized;
        {
        ...
        private bool ReadOptionalHeaderNTAdditionalFields64(
          ref MemoryReader memReader
        )
        //^ requires this.ReaderState >= ReaderState.Initialized;
        {
            ...
            _optionalHeaderNTAdditionalFields.ImageBase = memReader.ReadUInt64();
            _optionalHeaderNTAdditionalFields.SectionAlignment = memReader.ReadInt32();
            _optionalHeaderNTAdditionalFields.FileAlignment = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.MajorOperatingSystemVersion = memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.MinorOperatingSystemVersion = memReader.ReadUInt16();
            ...
            _optionalHeaderNTAdditionalFields.Subsystem = (Subsystem)memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.DllCharacteristics = (DllCharacteristics)memReader.ReadUInt16();
            _optionalHeaderNTAdditionalFields.SizeOfStackReserve = memReader.ReadUInt64();
            _optionalHeaderNTAdditionalFields.SizeOfStackCommit = memReader.ReadUInt64();
            _optionalHeaderNTAdditionalFields.SizeOfHeapReserve = memReader.ReadUInt64();
            _optionalHeaderNTAdditionalFields.SizeOfHeapCommit = memReader.ReadUInt64();
            _optionalHeaderNTAdditionalFields.LoaderFlags = memReader.ReadUInt32();
            _optionalHeaderNTAdditionalFields.NumberOfRvaAndSizes = memReader.ReadInt32();
            return true;
        }

        private bool ReadOptionalHeaderDirectoryEntries(
          ref MemoryReader memReader
        )
        //^ requires this.ReaderState >= ReaderState.Initialized;
        {
            ...
            _optionalHeaderDirectoryEntries.ExportTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.ExportTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.ImportTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.ImportTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.ResourceTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.ResourceTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.ExceptionTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.ExceptionTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.CertificateTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.CertificateTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.BaseRelocationTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.BaseRelocationTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.DebugTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.DebugTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.CopyrightTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.CopyrightTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.GlobalPointerTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.GlobalPointerTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.ThreadLocalStorageTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.ThreadLocalStorageTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.LoadConfigTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.LoadConfigTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.BoundImportTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.BoundImportTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.ImportAddressTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.ImportAddressTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.DelayImportTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.DelayImportTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.COR20HeaderTableDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.COR20HeaderTableDirectory.Size = memReader.ReadUInt32();
            _optionalHeaderDirectoryEntries.ReservedDirectory.RelativeVirtualAddress = memReader.ReadInt32();
            _optionalHeaderDirectoryEntries.ReservedDirectory.Size = memReader.ReadUInt32();
            return true;
        }
        ...
        //^ requires this.ReaderState >= ReaderState.Initialized;
        {
            int numberOfSections = _COFFFileHeader.NumberOfSections;
        ...
        //^ requires this.ReaderState >= ReaderState.Initialized;
        {
            ...
            this.Win32ResourceMemoryReader = new MemoryReader(this.DirectoryToMemoryBlock(_optionalHeaderDirectoryEntries.ResourceTableDirectory));
            return true;
        }
        ...
        //^ requires this.ReaderState >= ReaderState.PEFile;
        {
            foreach (SectionHeader sectionHeaderIter in _sectionHeaders)
            {
        ...
        private string MetadataStreamName
        {
            get
            {
        ...
        //^ requires this.ReaderState >= ReaderState.PEFile;
        {
            MemoryBlock memBlock = this.DirectoryToMemoryBlock(_optionalHeaderDirectoryEntries.COR20HeaderTableDirectory);
            if (memBlock.Length < _optionalHeaderDirectoryEntries.COR20HeaderTableDirectory.Size)
            {
        ...
        private bool ReadMetadataHeader(
          ref MemoryReader memReader
        )
        //^ requires this.ReaderState >= ReaderState.PEFile;
        {
        ...
        private bool ReadStorageHeader(
          ref MemoryReader memReader
        )
        //^ requires this.ReaderState >= ReaderState.PEFile;
        {
            ...
            _storageHeader.NumberOfStreams = memReader.ReadInt16();
            return true;
        }

        private bool ReadStreamHeaders(
          ref MemoryReader memReader
        )
        //^ requires this.ReaderState >= ReaderState.PEFile;
        {
        ...
        private bool ProcessAndCacheStreams(
        ...
        private uint[] _metadataTableRowCount;
        ...
        private bool ReadMetadataTableInformation(
          ref MemoryReader memReader
        )
        //^ requires this.ReaderState >= ReaderState.CORModule;
        {
            ...
            _metadataTableRowCount = new uint[numberOfTables];
            uint[] metadataTableRowCount = _metadataTableRowCount;
        ...
        private bool ProcessAndCacheMetadataTableBlocks(
        ...
        //^ requires this.ReaderState >= ReaderState.CORModule;
        {
            ...
            uint[] rowCountCompressedArray = _metadataTableRowCount;
