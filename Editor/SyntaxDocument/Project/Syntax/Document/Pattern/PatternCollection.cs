...
using T = AIMS.Libraries.CodeEditor.Syntax.Pattern;
...
namespace AIMS.Libraries.CodeEditor.Syntax
{
	...
	/// 
	/// </summary>
	public sealed class PatternCollection : ICollection, IList, IEnumerable, ICloneable
	{
...
/// <param name="array"></param>
		public PatternCollection(T[] array)
		{
			AddRange(array);
		}
...
/// </summary>
		...
		{
			private PatternCollection m_collection;
			private int m_index;
