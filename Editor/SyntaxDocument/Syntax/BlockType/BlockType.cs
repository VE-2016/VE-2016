...
namespace AIMS.Libraries.CodeEditor.Syntax
{
    ...
    public class BlockType
    {
        ...
        public void AddToLookupTable(Pattern pattern)
        {
            ...
            {
                _tmpSimplePatterns.Add(pattern);
            }
        }
        ...
        public void BuildLookupTable()
        {
            ...
            _tmpSimplePatterns.Sort(comparer);
            foreach (Pattern p in _tmpSimplePatterns.ToArray())
            {
                if (p == null)
                    continue;
