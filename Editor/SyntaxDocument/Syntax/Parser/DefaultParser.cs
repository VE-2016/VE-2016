...
namespace AIMS.Libraries.CodeEditor.Syntax.SyntaxDocumentParsers
{
    ...
    {
        private Language _mLanguage;
        private SyntaxDocument _mDocument;
        ...
        private void MakeSame(int RowIndex)
        {
            ...
            while (seg != null)
            {
                foreach (Word w in row.mWords.ToArray())
                {
                    if (w == null)
                        continue;
        ...
        public void ParseLine(int index, bool ParseKeywords)
        {
            ...
            {
                if (_version != this.Language.Version)
                {
                    this.Language.UpdateLists();
                    _version = this.Language.Version;
                }
            }
        ...
        private void InternalParseLine(int index, bool ParseKeywords)
        {
            ...
            else
            {
                if (Row.StartSegment == null)
                {
                    ...
                    Row.StartSegment.BlockType = _mLanguage.MainBlock;
                }
            }
        ...
        /* private void ParseSegments(Row Row)
         {
