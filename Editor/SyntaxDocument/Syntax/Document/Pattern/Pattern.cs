...
namespace AIMS.Libraries.CodeEditor.Syntax
{
    ...
    public sealed class Pattern
    {
        ...
        private Regex _rx;
        private Regex _rx2;
        private char[] _patternBuffer = null;
        ...
        public Pattern(string pattern, bool iscomplex)
        {
            ...
            {
                IsComplex = true;
                _rx = new Regex(StringPattern, RegexOptions.Compiled);
                _rx2 = new Regex(StringPattern, RegexOptions.Compiled | RegexOptions.IgnoreCase);
            }
            else
            {
                _patternBuffer = pattern.ToCharArray();
                IsComplex = false;
            }
        }
        ...
        private bool CharIsSeparator(string Text, int Position)
        {
            ...
            char s = Text[Position]; // Text.Substring(Position, 1);
        ...
        {
            MatchCollection mc = _rx.Matches(Text);
            int pos = 0;
            string p = "";
