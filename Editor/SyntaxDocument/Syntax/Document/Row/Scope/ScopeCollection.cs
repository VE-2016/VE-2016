...
using T = AIMS.Libraries.CodeEditor.Syntax.Scope;
...
namespace AIMS.Libraries.CodeEditor.Syntax
{
    ...
    /// 
    /// </summary>
    public sealed class ScopeCollection : ICollection, IList, IEnumerable, ICloneable
    {
        ...
        {
            private ScopeCollection _collection;
            private int _index;
