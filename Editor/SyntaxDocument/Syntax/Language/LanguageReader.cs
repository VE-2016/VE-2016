...
//	Copyright (C) 2005  Sebastian Faltoni <sebastian@dotnetAIMS.Libraries.org>
//	
...
namespace AIMS.Libraries.CodeEditor.Syntax
{
    ...
    public class SyntaxLoader
    {
        ...
        private static bool s_useUserCustomStyles = false;

        public Hashtable GetBlocks() { return _Blocks; }

        //protected BlockType		mLanguage.MainBlock=null;

        private static string s_userCustomStyles = null;
        ...
        {
            get { return SyntaxLoader.s_userCustomStyles; }
            set { SyntaxLoader.s_userCustomStyles = value; }
        }
        ...
        {
            get { return s_useUserCustomStyles; }
            set { s_useUserCustomStyles = value; }
        }
        ...
        public Language Load(Stream stream)
        {
            ...
            if (s_useUserCustomStyles && Directory.Exists(s_userCustomStyles))
            {
        ...
        private BlockType GetBlock(string Name)
        {
            ...
            {
                AIMS.Libraries.CodeEditor.Syntax.BlockType b = new AIMS.Libraries.CodeEditor.Syntax.BlockType(_Language);
                _Blocks.Add(Name, b);
            }
