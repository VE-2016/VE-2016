...
namespace AIMS.Libraries.Scripting.NRefactory.Visitors
{
    ...
    {
        private Stack<CodeNamespace> _namespaceDeclarations = new Stack<CodeNamespace>();
        private Stack<CodeTypeDeclaration> _typeDeclarations = new Stack<CodeTypeDeclaration>();
        private Stack<CodeStatementCollection> _codeStack = new Stack<CodeStatementCollection>();
        private List<CodeVariableDeclarationStatement> _variables = new List<CodeVariableDeclarationStatement>();

        private TypeDeclaration _currentTypeDeclaration = null;

        private IEnvironmentInformationProvider _environmentInformationProvider = new DummyEnvironmentInformationProvider();

        public IEnvironmentInformationProvider EnvironmentInformationProvider
        {
            get
            {
                return _environmentInformationProvider;
            }
            set
            {
                _environmentInformationProvider = value;
            }
        }

        // dummy collection used to swallow statements
        private CodeStatementCollection _nullStmtCollection = new CodeStatementCollection();
        ...
        private void AddStmt(CodeStatement stmt)
        {
            if (_codeStack.Count == 0)
                return;
            CodeStatementCollection stmtCollection = _codeStack.Peek();
        ...
        #region AIMS.Libraries.Scripting.SharpRefactory.Parser.IASTVisitor interface implementation
        public override object VisitCompilationUnit(CompilationUnit compilationUnit, object data)
        {
            ...
            _namespaceDeclarations.Push(globalNamespace);
        ...
        public override object VisitNamespaceDeclaration(NamespaceDeclaration namespaceDeclaration, object data)
        {
            ...
            foreach (CodeNamespaceImport import in ((CodeNamespace)_namespaceDeclarations.Peek()).Imports)
            {
                currentNamespace.Imports.Add(import);
            }
            _namespaceDeclarations.Push(currentNamespace);
            namespaceDeclaration.AcceptChildren(this, data);
            _namespaceDeclarations.Pop();
        ...
        public override object VisitUsingDeclaration(UsingDeclaration usingDeclaration, object data)
        {
            ...
            {
                _namespaceDeclarations.Peek().Imports.Add(new CodeNamespaceImport(u.Name));
            }
            return null;
        }
        ...
        {
            TypeDeclaration oldTypeDeclaration = _currentTypeDeclaration;
            ...
            _typeDeclarations.Push(codeTypeDeclaration);
            typeDeclaration.AcceptChildren(this, data);
            _typeDeclarations.Pop();

            if (_typeDeclarations.Count > 0)
            {
                _typeDeclarations.Peek().Members.Add(codeTypeDeclaration);
            }
            else
            {
                _namespaceDeclarations.Peek().Types.Add(codeTypeDeclaration);
            }
            _currentTypeDeclaration = oldTypeDeclaration;
        ...
        public override object VisitFieldDeclaration(FieldDeclaration fieldDeclaration, object data)
        {
            for (int i = 0; i < fieldDeclaration.Fields.Count; ++i)
            {
                ...
                if (fieldType.IsNull)
                {
                    fieldType = new TypeReference(_typeDeclarations.Peek().Name);
                }
                ...
                _typeDeclarations.Peek().Members.Add(memberField);
            }
        ...
        public override object VisitMethodDeclaration(MethodDeclaration methodDeclaration, object data)
        {
            ...
            _codeStack.Push(memberMethod.Statements);

            _typeDeclarations.Peek().Members.Add(memberMethod);
        ...
        public override object VisitIfElseStatement(IfElseStatement ifElseStatement, object data)
        {
            ...
            _codeStack.Push(ifStmt.TrueStatements);
            ...
            _codeStack.Push(ifStmt.FalseStatements);
        ...
        public override object VisitForStatement(ForStatement forStatement, object data)
        {
            ...
            if (forStatement.Initializers.Count > 0)
            {
                ...
                foreach (object o in forStatement.Initializers)
                {
                    ...
                    if (o is Statement)
                    {
                        _codeStack.Push(_nullStmtCollection);
            ...
            _codeStack.Push(forLoop.Statements);
        ...
        public override object VisitTryCatchStatement(TryCatchStatement tryCatchStatement, object data)
        {
            ...
            _codeStack.Push(tryStmt.TryStatements);
            ...
            {
                _codeStack.Push(tryStmt.FinallyStatements);
            ...
            foreach (CatchClause clause in tryCatchStatement.CatchClauses)
            {
                ...
                _codeStack.Push(catchClause.Statements);
        ...
        {
            bool isField = _environmentInformationProvider.HasField(type, fieldName);
        ...
        {
            foreach (CodeVariableDeclarationStatement variable in _variables)
            {
        ...
        {
            if (_currentTypeDeclaration == null) // e.g. in unit tests
                return false;
            foreach (INode node in _currentTypeDeclaration.Children)
            {
            ...
            //field detection for fields\props inherited from base classes
            if (_currentTypeDeclaration.BaseTypes.Count > 0)
            {
                return IsField(_currentTypeDeclaration.BaseTypes[0].ToString(), identifier);
            }
            return false;
        }
