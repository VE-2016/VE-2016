...
namespace AIMS.Libraries.Scripting.NRefactory.Parser
{
    ...
    public abstract class AbstractLexer : ILexer
    {
        ...
        private string[] _specialCommentTags = null;
        ...
        private bool _skipAllComments = false;

        public bool SkipAllComments
        {
            get
            {
                return _skipAllComments;
            }
            set
            {
                _skipAllComments = value;
            }
        }
        ...
        public string[] SpecialCommentTags
        {
            get
            {
                return _specialCommentTags;
            }
            set
            {
                _specialCommentTags = value;
                specialCommentHash = null;
                if (_specialCommentTags != null && _specialCommentTags.Length > 0)
                {
                    specialCommentHash = new Hashtable();
                    foreach (string str in _specialCommentTags)
                    {
        ...
        /// <summary>
        /// The current Token. <seealso cref="AIMS.Libraries.Scripting.NRefactory.Parser.Token"/>
        /// </summary>
        public Token Token
        {
            get
        ...
        /// <summary>
        /// The next Token (The <see cref="Token"/> after <see cref="NextToken"/> call) . <seealso cref="AIMS.Libraries.Scripting.NRefactory.Parser.Token"/>
        /// </summary>
        ...
        public virtual Token NextToken()
        {
            if (curToken == null)
            {
                ...
                //Console.WriteLine(AIMS.Libraries.Scripting.NRefactory.Parser.CSharp.Tokens.GetTokenString(curToken.kind) + " -- " + curToken.val + "(" + curToken.kind + ")");
                return curToken;
            }
        ...
        protected int GetHexNumber(char digit)
        {
            ...
            errors.Error(_line, _col, String.Format("Invalid hex number '" + digit + "'"));
            return 0;
        }
