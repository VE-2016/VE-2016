...
//     <owner name="Andrea Paatz" email="Rajneesh.Noonia@Xansa.com"/>
...
namespace AIMS.Libraries.Scripting.NRefactory.Parser.CSharp
{
    internal sealed class Lexer : AbstractLexer
    {
        ...
        private char[] _identBuffer = new char[MAX_IDENTIFIER_LENGTH];
        ...
        private string ReadIdent(char ch, out bool canBeKeyword)
        {
                ...
                if (ch == '\\')
                {
                    ...
                    if (surrogatePair != null)
                    {
                        ...
                        for (int i = 0; i < surrogatePair.Length - 1; i++)
                        {
                            ...
                            {
                                _identBuffer[curPos++] = surrogatePair[i];
                            }
                        }
            ...
            return new String(_identBuffer, 0, curPos);
        }
        ...
        private char[] _escapeSequenceBuffer = new char[12];
        ...
        private string ReadEscapeSequence(out char ch, out string surrogatePair)
        {
            ...
            switch (c)
            {
                ...
                case 'x':
                    ...
                    _escapeSequenceBuffer[curPos++] = c;
            ...
            return new String(_escapeSequenceBuffer, 0, curPos);
        }
