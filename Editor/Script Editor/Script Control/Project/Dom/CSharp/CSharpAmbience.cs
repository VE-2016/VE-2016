...
namespace AIMS.Libraries.Scripting.Dom.CSharp
{
    public class CSharpAmbience : AbstractAmbience
    {
        ...
        {
            get { return AIMS.Libraries.Scripting.NRefactory.Ast.TypeReference.PrimitiveTypesCSharpReverse; }
        }

        private static CSharpAmbience s_instance = new CSharpAmbience();
