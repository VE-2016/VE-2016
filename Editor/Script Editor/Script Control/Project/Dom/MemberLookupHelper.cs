...
namespace AIMS.Libraries.Scripting.Dom
{
    ...
    public static class MemberLookupHelper
    {
        ...
        private static IReturnType[][] ExpandParametersAndSubstitute(IList<IMethodOrProperty> list,
                                                             IReturnType[] arguments,
        ...
        private static int GetBetterFunctionMember(IReturnType[] arguments,
        ...
        #region IsApplicable
        private static bool IsApplicable(IList<IParameter> parameters,
                                 IReturnType[] arguments,
                                 bool allowAdditionalArguments,
                                 out int score,
                                 out bool expanded)
