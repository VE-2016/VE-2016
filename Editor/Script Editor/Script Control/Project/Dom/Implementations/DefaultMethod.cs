...
namespace AIMS.Libraries.Scripting.Dom
{
    ...
    public class DefaultMethod : AbstractMember, IMethod
    {
        ...
        public override IMember Clone()
        {
            ...
            p._typeParameters = _typeParameters;
            p._documentationTag = DocumentationTag;
            p._isExtensionMethod = _isExtensionMethod;
        ...
        public override string DotNetName
        {
            get
            {
                if (_typeParameters == null || _typeParameters.Count == 0)
                    ...
                    return base.DotNetName + "``" + _typeParameters.Count;
            }
        }

        private string _documentationTag;

        public override string DocumentationTag
        {
            get
            {
                if (_documentationTag == null)
                {
                    ...
                    _documentationTag = b.ToString();
                }
                return _documentationTag;
            }
        }
