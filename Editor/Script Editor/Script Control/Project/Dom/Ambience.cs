...
namespace AIMS.Libraries.Scripting.Dom
{
    ...
    {
        private ConversionFlags _conversionFlags = ConversionFlags.StandardConversionFlags;

        public ConversionFlags ConversionFlags
        {
            get
            {
                return _conversionFlags;
            }
            set
            {
                _conversionFlags = value;
            }
        }
        ...
        public bool ShowReturnType
        {
            get
            {
                return (_conversionFlags & ConversionFlags.ShowReturnType) == ConversionFlags.ShowReturnType;
            }
        }
        ...
        public bool ShowAccessibility
        {
            get
            {
                return (_conversionFlags & ConversionFlags.ShowAccessibility) == ConversionFlags.ShowAccessibility;
            }
        }
        ...
        public bool ShowParameterNames
        {
            get
            {
                return (_conversionFlags & ConversionFlags.ShowParameterNames) == ConversionFlags.ShowParameterNames;
            }
        }
        ...
        public bool UseFullyQualifiedNames
        {
            get
            {
                return (_conversionFlags & ConversionFlags.UseFullyQualifiedNames) == ConversionFlags.UseFullyQualifiedNames;
            }
        }
        ...
        public bool ShowModifiers
        {
            get
            {
                return (_conversionFlags & ConversionFlags.ShowModifiers) == ConversionFlags.ShowModifiers;
            }
        }
        ...
        public bool ShowInheritanceList
        {
            get
            {
                return (_conversionFlags & ConversionFlags.ShowInheritanceList) == ConversionFlags.ShowInheritanceList;
            }
        }
        ...
        public bool IncludeHTMLMarkup
        {
            get
            {
                return (_conversionFlags & ConversionFlags.IncludeHTMLMarkup) == ConversionFlags.IncludeHTMLMarkup;
            }
        }
        ...
        public bool UseFullyQualifiedMemberNames
        {
            get
            {
                return UseFullyQualifiedNames && !((_conversionFlags & ConversionFlags.QualifiedNamesOnlyForReturnTypes) == ConversionFlags.QualifiedNamesOnlyForReturnTypes);
            }
        }
        ...
        public bool IncludeBodies
        {
            get
            {
                return (_conversionFlags & ConversionFlags.IncludeBodies) == ConversionFlags.IncludeBodies;
            }
        }
