...
namespace AIMS.Libraries.Scripting
{
    ...
    public static class FileUtility
    {
        ...
        private readonly static char[] s_separators = { Path.DirectorySeparatorChar, Path.AltDirectorySeparatorChar, Path.VolumeSeparatorChar };
        private static string s_applicationRootPath = AppDomain.CurrentDomain.BaseDirectory;
        ...
        public static string ApplicationRootPath
        {
            get
            {
                return s_applicationRootPath;
            }
            set
            {
                s_applicationRootPath = value;
            }
        }
