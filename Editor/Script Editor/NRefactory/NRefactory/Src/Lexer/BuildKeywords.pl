...
sub write_unittests {
	...
	print DAT "using AIMS.Libraries.Scripting.NRefactory.Parser;\n";
	print DAT "using AIMS.Libraries.Scripting.NRefactory.PrettyPrinter;\n";
	
	print DAT "\n";
	print DAT "namespace AIMS.Libraries.Scripting.NRefactory.Tests.Lexer\n";
	print DAT "{\n";
