...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    public static class ImageServiceHelper
    {
        ...
        /// <returns></returns>
        public static unsafe Bitmap GetImage(Bitmap mask, Color glyph, Color background, Color? border = null)
        {
        ...
        public static unsafe Bitmap MaskImages(Bitmap input, Bitmap maskArrow)
        {
