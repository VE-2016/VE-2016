...
namespace AIMS.Libraries.CodeEditor.WinForms
{
    ...
    public class FormatLabelControl : Widget
    {
        ...
        private void InitializeComponent()
        {
            ...
            _vScroll.TabIndex = 4;
            _vScroll.Scroll += new System.Windows.Forms.ScrollEventHandler(this.vScroll_Scroll);
            // 
            // hScroll
            // 
        ...
        private void InitScrollbars()
        {
            ...
            {
                _vScroll.Left = this.ClientWidth - _vScroll.Width;
                _vScroll.Top = 0;
                _vScroll.Height = this.ClientHeight - _hScroll.Height;

                _hScroll.Left = 0;
                _hScroll.Top = this.ClientHeight - _hScroll.Height;
                _hScroll.Width = this.ClientWidth - _vScroll.Width;
            ...
            else if (this.ScrollBars == ScrollBars.Vertical)
            {
                _vScroll.Left = this.ClientWidth - _vScroll.Width;
                _vScroll.Top = 0;
                _vScroll.Height = this.ClientHeight;
            ...
            else if (this.ScrollBars == ScrollBars.Horizontal)
            {
                ...
                _hScroll.Left = 0;
                _hScroll.Top = this.ClientHeight - _hScroll.Height;
                _hScroll.Width = this.ClientWidth;
