...
namespace AIMS.Libraries.CodeEditor.WinForms
{
    ...
    public class ListItem : IComparable
    {
        ...
        /// <summary>
        /// The tooltip Extra data that should be displayed when selecting a ListItem
        /// </summary>
        ...
        /// 
        public ICompletionData CodeCompletionData = null;
        ...
        public ListItem(string text, int type, string tooltip, string inserttext, string extendedData)
        {
            Text = text;
            Type = type;
            ToolTip = tooltip;
