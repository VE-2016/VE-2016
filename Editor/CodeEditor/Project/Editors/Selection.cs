...
namespace AIMS.Libraries.CodeEditor.WinForms
{
	...
	public class Selection
	{
        ...
        public string[]  Outdents()
        {
            ...
            int X = Control.Caret.Position.X;
            int Y = Control.Caret.Position.Y;
        ...
        {
            return Control.Caret.Position.Y;
        }

        public Point GetCursor()
        {
            return new Point(Control.Caret.Position.X, Control.Caret.Position.Y);
        }


        public string GetCaretWord()
        {
            Row row = Control.Document[Control.Caret.Position.Y];



            Word w = row.GetCaretWord(Control.Caret.Position.X);
