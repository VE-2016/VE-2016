...
namespace AIMS.Libraries.CodeEditor.WinForms
{
    ...
    public sealed class EditViewControl : SplitViewChildWidget
    {
        ...
        void AutoList_VisibleChanged(object sender, EventArgs e)
        {
        ...
        public void ShowCompletionWindow(ICompletionDataProvider completionDataProvider, char ch)
        {
            ...
            if (InsightWindowVisible)
            {
                CloseInsightWindow(null, null);
            }
            ICompletionData[] completionData = completionDataProvider.GenerateCompletionData(this.FileName, this, ch);
            if (completionData == null || completionData.Length == 0)
            {
                this.AutoListVisible = false;
                return;
            }
            //      this.Caret.CurrentRow.AddToParseQueue();

            Word curWord = this.Caret.CurrentWord;
            TextPoint tp = null;
            if (ch == '\0')
            {
                ...
                if (curWord != null)
                {
                    // control space with some word already typed
                    tp = this.Caret.Position;
                    startOffset = new TextPoint(curWord.Column, tp.Y);
                }
                else
                {
                    tp = new TextPoint(this.Caret.Position.X + 1, this.Caret.Position.Y);
                    startOffset = new TextPoint(this.Caret.Position.X + 1, this.Caret.Position.Y);
                }
            }
            else
            {
            ...
            this._AutoListStartPos = tp;

            // Set Caret correct Position before TryAutoCompletion;
            if (ch == '\0')
                if (TryAutoCompletion(completionData))
                    return;

            this._AutoList.BeginLoad();
            this._AutoList.Clear();
            foreach (ICompletionData data in completionData)
            {
                this._AutoList.Add(data, data.ImageIndex);
            }

            this._AutoList.EndLoad();
            this.AutoListVisible = true;
            if (completionDataProvider != null && completionDataProvider.DefaultIndex >= 0)
            {
                this._AutoList.SelectItemByIndex(completionDataProvider.DefaultIndex);
            }
            else
            {
                this._AutoList.SelectItemByIndex(0);
            }
        }

        InsightWindow.InsightWindow insightWindow = null;
        ...
        public bool InsightWindowVisible
        {
            get
            {
                return (insightWindow != null) && insightWindow.Visible;
            }
        }
        ...
        private void CreateInfoTip()
        {
            if (this._CodeEditor != null && !this._CodeEditor.DisableInfoTip && this._InfoTip == null)
            {
                ...
                //NativeUser32Api.SetWindowLong(this.InfoTip.Handle,
                //                            NativeUser32Api.GWL_STYLE,
                //                            (int)NativeUser32Api.WS_CHILD);

                //this.InfoTip.TopLevel = false;
        ...
        public EditViewControl(CodeEditorControl Parent) : base()
        {
            ...
            //CreateFindForm ();
            CreateInfoTip();
            //this.InfoTip.SetBackground(SystemColors.Control);
            ...
            //this.Paint += EditViewControl_Paint;

            // this.BeginInvoke(new Action(() => { MouseMoveResolve(); }));

            // resolver w = MouseMoveResolve;
            //w.BeginInvoke( null, null);

            //this.Load += EditViewControl_Load; 
        ...
        //private void EditViewControl_Load(object sender, EventArgs e)
        //{
        //    Thread workerThread = new Thread(MouseMoveResolver);
        ...
        private void InitializeComponent()
        {
            ...
            this.CaretTimer = new AIMS.Libraries.CodeEditor.Core.Timers.WeakTimer(this.components);
            this.tooltip = new System.Windows.Forms.ToolTip(this.components);
            this.IntelliMouse = new AIMS.Libraries.CodeEditor.WinForms.IntelliMouse.IntelliMouseControl();
            this.panel1 = new System.Windows.Forms.Panel();
            ((System.ComponentModel.ISupportInitialize)(this.Filler)).BeginInit();
            this.SuspendLayout();
            // 
            // LeftThumb
            // 
            ...
            this.Filler.Size = new System.Drawing.Size(100, 50);
            ...
            // IntelliMouse
            // 
            this.IntelliMouse.Image = ((System.Drawing.Bitmap)(resources.GetObject("IntelliMouse.Image")));
            this.IntelliMouse.Location = new System.Drawing.Point(197, 157);
            this.IntelliMouse.Name = "IntelliMouse";
            this.IntelliMouse.Size = new System.Drawing.Size(28, 28);
            this.IntelliMouse.TabIndex = 4;
            this.IntelliMouse.TransparencyKey = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(0)))), ((int)(((byte)(255)))));
            this.IntelliMouse.Visible = false;
            this.IntelliMouse.BeginScroll += new System.EventHandler(this.IntelliMouse_BeginScroll);
            this.IntelliMouse.EndScroll += new System.EventHandler(this.IntelliMouse_EndScroll);
            this.IntelliMouse.Scroll += new AIMS.Libraries.CodeEditor.WinForms.IntelliMouse.ScrollEventHandler(this.IntelliMouse_Scroll);
            // 
            // panel1
            // 
            ...
            // EditViewControl
            // 
            this.Controls.Add(this.IntelliMouse);
            ...
            this.Controls.SetChildIndex(this.IntelliMouse, 0);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.Filler)).EndInit();
            this.ResumeLayout(false);
...
//                ShadowedWords();
        ...
        System.Threading.Timer updateTimer { get; set; }
        ...
        protected override void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            //if (AutoListVisible && !e.Handled && _CodeEditor.AutoListAutoSelect)
            {
                ...
                //compile(this.Document.Text, CodeEditor.vp);
            }
        }
                            ...
                            if (w != null)
                               ...
                               // MessageBox.Show("Entered word - " + w.Text);
                                ...
                                if (mousemoveword != w.Text)
                                    ...
                                    //if (w.InfoTip != null)
                                    {
                                        //InfoTipForm c = tooltip as InfoTipForm;
                                        //InfoTip.SetBackground(SystemColors.Control);
                                        //InfoTip.InitialDelay = this.TooltipDelay;
                                        ...
                                        //if(InfoTip.IsTheSame(w.InfoTip) == false)
                                        //string textstring = "";
        ...
        static void compile(string source, VSProject vp)
        {
        ...
        static string [] GetAssemblyNames(string source)
        {
    ...
    public class PanelExt : Panel
    {
        ...
        Dictionary<string,string> d { get; set; }
        ...
        public string ResolveText(ResolveResult r)
        {
            ...
            else  if (r.GetType() == typeof(ConstantResolveResult))
            {
               ...
               text = rr.Type.Name + " : " + s.Substring(0, w + 1);
